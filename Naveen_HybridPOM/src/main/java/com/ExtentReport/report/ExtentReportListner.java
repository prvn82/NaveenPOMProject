package com.ExtentReport.report;
...
public class ExtentReportListner extends TestBase {
    ...
    public static ExtentReports createInstance() {
        ...
        extent.setSystemInfo("Testing Application URL",Config.getProperty("url"));
        extent.setSystemInfo("Browser Name",Config.getProperty("BrowerName"));
